...
import static messaging.GLOBAL_STRINGS.REPORT_SERVICE.HANDLE.REPORT_STATUS_REQUESTED;
...
public class ReportService {
	...
	public static final String REPORT_STATUS_REQUEST = REPORT_STATUS_REQUESTED;	// REPORT_STATUS_REQUESTED
